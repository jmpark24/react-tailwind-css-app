  ...
  return (
    <section name="testimonials" className="w-full my-24 text-white bg-slate-700">
      <div className="max-w-6xl px-5 mx-auto text-center py-12">
        <h2 className="test-4xl font-bold">Testimonials</h2>
        <p className="py-8 text-2xl text-white">
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quam eaque laudantium sit rem dignissimos sed.
        </p>
        <div className="flex flex-col mt-24 md:flex-row md:space-x-6">
          <div className="flex flex-col items-center p-6 space-y-6 rounded-lg bg-gray-100/30 md:w-1/3">
            ...
            <p className="text-sm">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos tempore reiciendis facilis iure, ea optio?
            </p>
          </div>
